...
//!Private Properties
	...
	/**
	 * Protect the store from external manipulation.
	 */
	...
	public function valueForKeyWithException($key) {
		...
		throw new ELSWAK_Dictionary_InvalidKey_Exception;
	}
	...
	public function removeValueForKeyWithException($key) {
		...
		throw new ELSWAK_Dictionary_InvalidKey_Exception('Unable to remove value. Invalid key provided.');
	}
